 <main id="main" class="main">
    ...
    <div class="col-lg-8">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Update Hotel or Lodges article</h5>

              <!-- Vertical Form -->
              <div class="row g-3">
              	<?php echo form_open_multipart('travel/updatehotel'); ?>
                <div class="col-12">
                  ...
                  <div class="row">
                    <div class="col-lg-4 col-md-4 col-6">
                      <p>Current Picture</p>
                      <img class="img-fluid" src="<?php echo base_url(); ?>assets/fileupload/<?php echo $hotellink; ?>">
                    </div>
                  </div>
                </div>
                <div class="col-12">
          ...
          <div class="row">
            <div class="text-center">
              <a class="btn btn-warning" href="<?php echo site_url('travel/hotels'); ?>">Go back</a>
            </div>
          </div>
      </div>
