  ...
  <div class="row">
    ...
    <div class="card">
      <div class="card-header">
        <img
              src="<?php echo base_url(); ?>dashboard/assets/fileupload/<?php echo $tenderlink; ?>"
              alt=""
        ...
        <div class="d-flex justify-content-between align-items-center">
          <div class="d-flex align-items-center">
            ...
            <div class="ms-3">
              ...
              <p class="text-muted mb-2"><?php echo $tenderbody;?></p>
            </div>
          </div>
        </div>
      </div>
      ...
      >
        <a
          ...
          href="<?php echo site_url('tenders/tenders'); ?>"
          role="button"
